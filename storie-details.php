...
<!-- Mirrored from demo.artureanec.com/html/Action European-Union Aids/mono/storie-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 12 May 2022 11:15:05 GMT -->
<head>
		<meta charset="UTF-8"/>
		...
		<title>Action European-Union Aids HTML Template</title>
		<!-- styles-->
		...
		<div class="page-wrapper">
			...
			<div class="aside-dropdown">
				<div class="aside-dropdown__inner"><span class="aside-dropdown__close">
						...
						<ul class="aside-menu">
							<li class="aside-menu__item aside-menu__item--has-child"><a class="aside-menu__link" href="javascript:void(0);"><span>Home</span></a>
								...
								<ul class="aside-menu__sub-list">
									<li><a href="https://demo.artureanec.com/html/Action European-Union Aids/index.html"><span>01 Home Color Style</span></a></li>
									<li><a href="https://demo.artureanec.com/html/Action European-Union Aids/front_2.html"> <span>02 Home Color Style</span></a></li>
									<li><a href="https://demo.artureanec.com/html/Action European-Union Aids/front_3.html"><span>03 Home Color Style</span></a></li>
							...
							<li class="aside-menu__item aside-menu__item--has-child aside-menu__item--active"><a class="aside-menu__link" href="javascript:void(0);"><span>Pages</span></a>
								...
								<ul class="aside-menu__sub-list">
									...
									<li class="item--active"><a href="storie-details.html"><span>Storie Details</span></a></li>
					...
					<div class="aside-dropdown__item">
						...
						<!-- aside menu end-->
						<div class="aside-inner"><span class="aside-inner__title">Email</span><a class="aside-inner__link" href="mailto:support@aeuaids.org">support@aeuaids.org</a></div>
								...
								<ul class="main-menu">
									...
									<li class="main-menu__item main-menu__item--has-child main-menu__item--active"><a class="main-menu__link" href="javascript:void(0);"><span>Pages</span></a>
										...
										<ul class="main-menu__sub-list sub-list--style-2">
											...
											<li><a href="event-details.html"><span>Event Details</span></a></li>
											<li><a href="stories.html"><span>Stories</span></a></li>
											<li class="item--active"><a href="storie-details.html"><span>Story Details</span></a></li>
											<li><a href="blog.html"><span>Blog</span></a></li>
											<li><a href="blog-post.html"><span>Blog Post</span></a></li>
											<li><a href="gallery.html"><span>Gallery</span></a></li>
											<li><a href="pricing.html"><span>Pricing Plans</span></a></li>
			...
			<main class="main">
				<section class="promo-primary">
					<picture>
						<source srcset="img/storie_details.jpg" media="(min-width: 992px)"/><img class="img--bg" src="img/storie_details.jpg" alt="img"/>
					</picture>
						...
						<div class="row">
							<div class="col-auto">
								<div class="align-container">
									<div class="align-container__item"><span class="promo-primary__pre-title">Action European-Union Aids</span>
										<h1 class="promo-primary__title"><span>Storie</span> <span>Details</span></h1>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-xl-8 offset-xl-2">
								<div class="storie-details__top">
									<div class="storie-details__img"><img class="img--bg" src="img/storie_details-img.jpg" alt="img"/></div>
									<div class="storie-details__description">
										<div class="row align-items-center">
											<div class="col-md-4 text-center text-md-left">
												<h5 class="storie-details__name">William Ellis</h5>
											</div>
											<div class="col-md-4 text-center text-md-left"><span class="storie-details__donation">Donation So Far: <strong>845$</strong></span></div>
											<div class="col-md-4 text-center text-md-right"><a class="button button--filled" href="#">+ Donate</a></div>
										</div>
									</div>
								</div>
								...
								<h6 class="storie-details__title">Save Homeless People</h6>
								...
								<p>Ut etipsum dolor sit amet, conse n pellentesqu no liues il Ut et congue augue Maecenas feec eros tristiq nsl lla pellent Ut et co augue Maec enas fermentum vel Maecena fermentum vel anteante</p>
								<p class="text-filled">Streamer fish California halibut Pacific saury. Slickhead grunion lake trout. Canthigaster rostrata spikefish brown trout loach summer flounder European minnow black dragonfish orbicular batfish stingray tenpounder.</p>
								<h6 class="storie-details__title">Giving Thankful to Helping Donor</h6>
								<p>Minnow snoek icefish velvet-belly shark, California halibut round stingray northern sea robin. Southern grayling trout-perch. Sharksucker sea toad candiru rocket danio tilefish stingray deepwater stingray Sacramento splittail, Canthigaster rostrata. Midshipman dartfish Modoc sucker, yellowtail kingfish basslet. Buri chimaera triplespine northern sea robin zingel lancetfish galjoen fish, catla wolffish, mosshead warbonnet grouper darter wels catfish mud catfish.</p>
			...
			<footer class="footer">
				<div class="container">
					<div class="row">
						...
						<div class="col-sm-6 col-lg-3">
							...
							<div class="footer-contacts">
								...
								<p class="footer-contacts__mail">Email: <a href="mailto:support@aeuaids.org">support@aeuaids.org</a></p>
							</div>
						</div>
						<div class="col-sm-6 col-lg-3">
					...
					<div class="row align-items-baseline">
						<div class="col-md-6">
							<p class="footer-copyright">© 2020 Action European-Union Aids Charity Template by Artureanec</p>
						</div>
						<div class="col-md-6">
