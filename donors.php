<?php include('./includes/header.php'); ?>
			...
			<main class="main">
				...
				<!-- donors inner start-->
				<section class="section donors-inner">
					<div class="container">
				...
				<section class="section info">
					<div class="container">
						<div class="row align-items-center margin-bottom">
							<div class="col-xl-5">
								<div class="heading heading--primary"><span class="heading__pre-title color--green">Who we work with</span>
						...
						<div class="row">
							<div class="col-12">
								<div class="info__img"><img src="img/info_img.png" alt="img"/></div>
							</div>
						</div>
					</div>
				</section>
									...
									<div class="row margin-bottom">
										<div class="col-12">
											<div class="heading heading--primary heading--center">
												<h2 class="heading__title no-margin-bottom color--white"><span>Founding</span> <span>Partner</span></h2>
											</div>
										</div>
									</div>
