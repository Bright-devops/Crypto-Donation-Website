...
<!-- Mirrored from demo.artureanec.com/html/Action European-Union Aids/mono/causes.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 12 May 2022 11:15:11 GMT -->
<head>
		<meta charset="UTF-8"/>
				...
				<div class="aside-dropdown__inner"><span class="aside-dropdown__close">
					...
					<div class="aside-dropdown__item d-lg-none d-block">
						<ul class="aside-menu">
							...
							<li class="aside-menu__item aside-menu__item--has-child aside-menu__item--active"><a class="aside-menu__link" href="javascript:void(0);"><span>Causes</span></a>
								<!-- sub menu start-->
								<ul class="aside-menu__sub-list">
									<li class="item--active"><a href="causes.html"><span>Causes 1</span></a></li>
						...
						<div class="col-auto">
							...
							<nav>
								<ul class="main-menu">
									...
									<li class="main-menu__item main-menu__item--has-child main-menu__item--active"><a class="main-menu__link" href="javascript:void(0);"><span>Causes</span></a>
										<!-- sub menu start-->
										<ul class="main-menu__sub-list">
											<li class="item--active"><a href="causes.html"><span>Causes 1</span></a></li>
											<li><a href="causes_2.html"> <span>Causes 2</span></a></li>
							...
							<div class="col-md-6 col-lg-4">
								<div class="causes-item causes-item--primary">
									<div class="causes-item__body">
										...
										<div class="causes-item__img">
											<div class="causes-item__badge">Food</div><img class="img--bg" src="img/causes_4.jpg" alt="img"/>
										</div>
										<div class="causes-item__lower">
											<div class="progress-bar">
							...
							<div class="col-md-6 col-lg-4">
								<div class="causes-item causes-item--primary">
									<div class="causes-item__body">
										...
										<div class="causes-item__img">
											<div class="causes-item__badge">Water Delivery</div><img class="img--bg" src="img/causes_5.jpg" alt="img"/>
										</div>
										<div class="causes-item__lower">
											<div class="progress-bar">
							...
							<div class="col-md-6 col-lg-4">
								<div class="causes-item causes-item--primary">
									<div class="causes-item__body">
										...
										<div class="causes-item__img">
											<div class="causes-item__badge">Education</div><img class="img--bg" src="img/causes_6.jpg" alt="img"/>
										</div>
										<div class="causes-item__lower">
											<div class="progress-bar">
						...
						<div class="col-sm-6 col-lg-3">
							...
							<nav>
								<ul class="footer-menu">
									...
									<li class="footer-menu__item footer-menu__item--active"><a class="footer-menu__link" href="causes.html">Causes</a></li>
								</ul>
							</nav>
							<!-- footer nav end-->
						</div>
...
<!-- Mirrored from demo.artureanec.com/html/Action European-Union Aids/mono/causes.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 12 May 2022 11:15:12 GMT -->
</html>