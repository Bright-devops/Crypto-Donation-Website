<?php include('./includes/header.php'); ?>
			...
			<main class="main">
						...
						<div class="row">
							<div class="col-auto">
								<div class="align-container">
									<div class="align-container__item"><span class="promo-primary__pre-title">Aljazeera Charity Media Network</span>
						...
						<div class="row offset-margin">
							...
							<div class="col-sm-6 col-lg-3">
								<div class="icon-item">
									...
									<div class="icon-item__text">
										<p>Email: <a class="icon-item__link" href="mailto:support@aeuaids.org">support@aeuaids.org</a></p>
									</div>
								</div>
							</div>
							<div class="col-sm-6 col-lg-3">
				...
				<!-- contacts end-->
				<!-- bottom bg start-->
				<section class="bottom-background" style="background-image: url(img/bottom-bg.html)"></section>
				<!-- bottom bg end-->
			</main>
			<!-- footer start-->
